...
# 			lr_ = 1.0/np.power(10, epoch/100+2) # lr decay from 0.01 every 100 epochs 
		...
		pickle_out.close()
		pickle_out = open('test_output_middlefuse_lr001_wd300.pickle','wb')
		pickle.dump(test_output,pickle_out,protocol=2)
		pickle_out.close()
		save_path = saver.save(sess, "/tmp/model_middlefuse_lr001_wd300.ckpt")
...
np.savez('loss_middlefuse_lr001_wd300.npz',train_epoch_loss=train_epoch_loss,eval_epoch_loss=eval_epoch_loss,train_epoch_mse=train_epoch_mse,eval_epoch_mse=eval_epoch_mse,test_mse=test_mse)
