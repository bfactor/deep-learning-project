function [labelSet,trainSet] = generateTrainingSet(labelFilename,trainFilename)
    ...
    labelSet = zeros(15,480,480);
    trainSet = zeros(15,480,480);
    ...
    % Generate 6 rotated images
    rot_vec = [-1 -90 -91 -180 -181 -270];
    sidx = 2;
    ...
    % Generate 6 translated images
    sidx = sidx + size(flip_vec,2);
    trans_vec = [16 -16 0 0 16 16; 0 0 16 -16 16 -16];
