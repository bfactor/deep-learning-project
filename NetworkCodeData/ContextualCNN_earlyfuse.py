...
# 			lr_ = 1.0/np.power(10, epoch/100+2) # lr decay from 0.01 every 100 epochs 
		...
		pickle_out = open('eval_output_earlyfuse_ep'+str(hm_epochs)+'_lr001_wd50.pickle','wb')
...
np.savez('loss_earlyfuse_ep'+str(hm_epochs)+'_lr001_wd50.npz',train_epoch_loss=train_epoch_loss,eval_epoch_loss=eval_epoch_loss,train_epoch_mse=train_epoch_mse,eval_epoch_mse=eval_epoch_mse,test_mse=test_mse)
