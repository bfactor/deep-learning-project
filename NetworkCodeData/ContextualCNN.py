...
def train_neural_network(x):
	...
	with tf.Session() as sess:
		...
		for epoch in range(hm_epochs):
			lr_ = 0.01
			cost_weight_ = max(1.0/np.power(10, epoch/300), 0.01) # cost_weight decay from 1 every 100 epochs until 0.01 
			print ('lr:', lr_)
...
np.savez('loss_lr001_wd300.npz',shuffle,train_epoch_loss,train_epoch_mse,eval_epoch_mse)
