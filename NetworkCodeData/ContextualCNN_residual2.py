...
def train_neural_network(x):
	...
	with tf.Session() as sess:
		...
		pickle_out = open("eval_output_residual2_ep"+str(hm_epochs)+"_lr001_wd50.pickle",'wb')
		pickle.dump(eval_output,pickle_out,protocol=2)
		pickle_out.close()
		pickle_out = open("test_output_residual2_ep"+str(hm_epochs)+"_lr001_wd50.pickle",'wb')
		pickle.dump(test_output,pickle_out,protocol=2)
		pickle_out.close()
		save_path = saver.save(sess, "/tmp/model_residual2_ep"+str(hm_epochs)+"_lr001_wd50.ckpt")
